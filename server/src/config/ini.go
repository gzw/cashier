...
var (
	DEFAULT_SECTION = "default"   // default section means if some ini file items not in section, make them in default section
...
// ParseFile create a new Config and parse the file configuration from the name file.
...
// a config represent the ini configuration.
// when set and get value, support key as section :name type.
type IniConfigContainer struct {
	filename       string
	data           map[string]map[string]string // section =>key:val
	sectionComment map[string]string            // seciton: comment
...
// Float returns the float value for a gvien key
...
// if the section is not existed, it panic
